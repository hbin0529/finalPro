...
<style>
 /* 로고폰트 */
  ...
  /* -----------------------------------메인바디 좌측 카테고리 스타일 모음----------------------------------- */
    ...
    .store_product_title{margin-left: 25px;  font-size: 17px; font-weight: bold; width:228px; height: 20pxh; overflow:hidden; white-space:nowrap; text-overflow: ellipsis;}
